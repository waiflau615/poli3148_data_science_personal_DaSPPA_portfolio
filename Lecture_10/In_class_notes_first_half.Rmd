---
title: "Lecture 10 in class notes (Data visualization section) "
...
d_t |>
  select(year, side_a, side_a_country, side_a_iso3c, side_b, side_b_country, side_b_iso3c) |> View()
...
# d_t_s_2 |> select(side_a_iso3c,centroid_xcoord_a, centroid_ycoord_a,
                  side_b_iso3c,centroid_xcoord_b, centroid_ycoord_b) |> View()
```
